...
from ..components.pluginPath import (
    DlcInfoPath,
    imgPath,
    infoPath,
    originalIllPath,
...
from .cls.type import idString, songString
...
class getInfo:
    nicklist: dict[idString, list[str]] = getFile.FileReader(infoPath / "nicklist.yaml") # type: ignore
    """默认别名,以id为key"""
    songnick : dict[str, list[idString]] = {}
    """以别名为key"""
    DLC_info: dict[str, list[str]] = {}
    """扩增曲目信息"""
    avatarid: dict[str, str] = {}
    """头像id"""
    tips: list[str] = getFile.FileReader(infoPath / "tips.yaml") # type: ignore
    """Tips"""
    ori_info: dict[idString, Any] = {}
    """原版信息"""
    songById: dict[idString, songString]
